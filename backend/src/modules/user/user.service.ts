...
export class UserService {
  ...
  async updateProfile(userId: number, data: {
    ...
    if (data.first_name !== undefined) { updates.push('first_name = ?'); params.push(data.first_name.trim()); }
    if (data.last_name !== undefined) { updates.push('last_name = ?'); params.push(data.last_name.trim() || null); }
    if (data.phone !== undefined) { updates.push('phone = ?'); params.push(data.phone.trim() || null); }
    if (data.avatar_url !== undefined) { updates.push('avatar_url = ?'); params.push(data.avatar_url || null); }
