-- ============================================================
-- Luv Kush Natural Database Schema
...
-- Disable foreign key checks to allow drops in any order
...
-- ────────────────────────────────────────────────────────────
-- 12. ORDER STATUSES (Lookup list table)
-- ────────────────────────────────────────────────────────────
...
-- A. Seed default order statuses
INSERT INTO `order_statuses` (`name`, `slug`, `color`, `sort_order`, `is_system`) VALUES
('Order Placed', 'pending', '#B87333', 1, 1),
('Confirmed', 'confirmed', '#3182CE', 2, 1),
('Processing', 'processing', '#805AD5', 3, 1),
('Quality Check', 'quality_check', '#319795', 4, 1),
('Shipped', 'shipped', '#D69E2E', 5, 1),
('Out For Delivery', 'out_for_delivery', '#4A5568', 6, 1),
('Delivered', 'delivered', '#38A169', 7, 1),
('Cancelled', 'cancelled', '#E53E3E', 8, 1),
('Refund Requested', 'refund_requested', '#DD6B20', 9, 1),
('Refunded', 'refunded', '#718096', 10, 1),
('Returned', 'returned', '#E53E3E', 11, 1);

-- B. Seed default categories required by the demo solutions
INSERT INTO `categories` (`id`, `name`, `slug`, `description`, `status`, `is_active`, `display_order`) VALUES
(15, 'Men\'s Wigs', 'men-wigs', 'Premium quality wigs designed for men.', 'active', 1, 1),
(16, 'Ladies\' Wigs', 'ladies-wigs', 'Beautiful and natural looking wigs for women.', 'active', 1, 2),
(17, 'Hair Patches', 'hair-patches', 'Premium hair patches and toupees.', 'active', 1, 3);

-- C. Seed default admin & test customer accounts
-- Note: Password is 'Admin@123' for both
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password_hash`, `role`, `status`) VALUES
(1, 'Admin', 'User', 'admin@luvkushnatural.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/ZNbxf5e', 'super_admin', 'active'),
(3, 'Test', 'Customer', 'customer@test.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/ZNbxf5e', 'customer', 'active');
