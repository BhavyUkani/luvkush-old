        ...
        <div class="top-actions">
          ...
          <button class="btn-primary" (click)="save()" [disabled]="saving() || loading()">
            @if (saving()) {
              ...
              {{ isNew() ? 'Create Patch' : 'Save Changes' }}
            }
          </button>
        </div>
      </div>
              ...
              <div class="form-grid">
                <div class="field">
                  ...
                  <div class="input-icon-wrap">
                    ...
                    <input type="number" [(ngModel)]="form().base_price" class="form-input has-icon" placeholder="3000" />
                  </div>
                </div>
                <div class="field">
                  <label>MRP</label>
                  <div class="input-icon-wrap">
                    <span class="input-icon">₹</span>
                    <input type="number" [(ngModel)]="form().mrp" class="form-input has-icon" placeholder="5000" />
                  </div>
                </div>
              ...
              <div class="form-grid">
                ...
                @if (form().payment_mode === 'partial') {
                  <div class="field">
                    ...
                    <div class="input-icon-wrap">
                      <span class="input-icon">₹</span>
                      <input type="number" [(ngModel)]="form().advance_amount" class="form-input has-icon" placeholder="1000" />
                    </div>
