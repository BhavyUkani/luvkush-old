...
@Component({
  ...
  template: `
    <div class="edit-page">
      ...
      <!-- Top Bar -->
      <div class="top-bar">
        <button class="btn-back" (click)="goBack()">← Hair Patches</button>
        <div class="top-title">
          <span>{{ isNew() ? 'Add Hair Patch' : (form().name || 'Edit Hair Patch') }}</span>
        </div>
        <div class="top-actions">
          <button class="btn-secondary" (click)="goBack()">Discard</button>
          <button class="btn-primary" (click)="save()" [disabled]="saving() || loading()">
            {{ saving() ? 'Saving…' : (isNew() ? 'Create Patch' : 'Save Changes') }}
          </button>
        </div>
      </div>
        ...
        <div class="layout">
          ...
          <div class="cards-col">
            ...
            <div class="card">
              ...
              <div class="form-grid">
                <div class="field field-full">
                  <label>Name *</label>
                  <input type="text" [(ngModel)]="form().name" class="form-input" placeholder="e.g. Natural Scalp Hair Patch" />
                </div>
                <div class="field field-full">
            ...
            <div class="card">
              ...
              @if (isNew()) {
                <div class="new-img-note">Save the patch first, then upload an image from the edit page.</div>
              } @else {
                <div class="img-upload-area">
                  @if (imgPreview() || form().primary_image) {
                    <img [src]="imgPreview() || imgUrl(form().primary_image)" class="current-img" alt="Patch image" />
                  } @else {
            ...
            <div class="card">
              ...
              <div class="form-grid">
                <div class="field field-full">
                  ...
                  <textarea [(ngModel)]="form().description" class="form-textarea" rows="5" placeholder="Full product description — materials, base type, density…"></textarea>
                </div>
                <div class="field field-full">
            ...
            <div class="card">
              ...
              <div class="form-grid">
                <div class="field field-full">
                  ...
                  <input type="text" [(ngModel)]="form().size_info" class="form-input" placeholder="e.g. 4×4, 5×5, 6×6, Custom" />
                </div>
                <div class="field field-full">
            ...
            <div class="card">
              ...
              <div class="form-grid">
                <div class="field">
                  <label>Price (₹) *</label>
                  <input type="number" [(ngModel)]="form().base_price" class="form-input" placeholder="3000" />
                </div>
                <div class="field">
                  <label>MRP (₹)</label>
                  <input type="number" [(ngModel)]="form().mrp" class="form-input" placeholder="5000" />
                </div>
              ...
              <div class="form-grid">
                ...
                @if (form().payment_mode === 'partial') {
                  <div class="field">
                    ...
                    <input type="number" [(ngModel)]="form().advance_amount" class="form-input" placeholder="1000" />
          ...
          <div class="preview-col">
            <div class="preview-panel">
              ...
              <div class="browser-chrome">
                ...
                <div class="chrome-url">luvkushnatural.com/hair-patches/…</div>
              </div>
              <div class="pv-outer">
                <div class="pv-scaler"
                  ...
                  <div class="pp" [class.pp-mobile]="previewDevice() === 'mobile'"
                    ...
                    <div class="pp-announce">Natural Hair Patches — Undetectable &amp; Comfortable · Free Fitting</div>
                    <div class="pp-head">
                    ...
                    <div class="pp-breadcrumb">Home &rsaquo; Hair Patches &rsaquo; <strong>{{ form().name || '…' }}</strong></div>
                    <div class="pp-hero">
                      <div class="pp-gallery">
                        <div class="pp-main-wrap">
                          ...
                          <span class="pp-sticker pp-patch-badge">Patch</span>
                        </div>
                      </div>
                      <div class="pp-info">
                        <h1 class="pp-name">{{ form().name || 'Hair Patch Name' }}</h1>
                        @if (form().short_description) { <p class="pp-sub">{{ form().short_description }}</p> }
                        <div class="pp-stars"><span class="pp-star-icons">★★★★★</span><span class="pp-review-ct">8 reviews</span></div>
                        ...
                        <button class="pp-buy-btn">Book Free Consultation</button>
                        ...
                        <div class="pp-pills">
                          ...
                          <span class="pp-pill">✂️ Expert Fitting</span>
                        </div>
                      </div>
                    </div>
                    @if (form().description) {
  ...
  styles: [`
    ...
    .pp-announce { background: #3D5A47; color: #fff; font-size: 11px; text-align: center; padding: 6px 12px; }
    ...
    .pp-patch-badge { background: #3D5A47; color: #fff; }
    ...
    .pp-add-btn { flex: 1; padding: 9px 14px; background: #3D5A47; color: #fff; border: none; border-radius: 6px; font-size: 12px; font-weight: 700; cursor: pointer; }
    .pp-buy-btn { width: 100%; padding: 9px; border: 2px solid #3D5A47; background: #fff; color: #3D5A47; border-radius: 6px; font-size: 12px; font-weight: 700; cursor: pointer; margin-bottom: 10px; }
    ...
    .pp-pill { font-size: 9px; padding: 3px 7px; background: rgba(61,90,71,0.08); color: #3D5A47; border-radius: 20px; font-weight: 600; }
...
export class AdminHairPatchEditComponent implements OnInit {
    ...
    this.api.get<any>(`/admin/hair-solutions/${id}`).subscribe({
      next: (res: any) => {
        ...
        this.form.set({
          ...
          mrp: String(d.mrp || ''), size_info: d.size_info || '',
  ...
  goBack(): void { this.router.navigate(['/admin/hair-patches']); }

  previewLive(): void { window.open('/hair-patches', '_blank'); }
  ...
  save(): void {
    ...
    req.subscribe({
      next: (res: any) => {
        ...
        this.toast.success(this.isNew() ? 'Hair patch created' : 'Hair patch updated');
        if (this.isNew()) {
          const newId = res.data?.id;
          newId
            ? this.router.navigate(['/admin/hair-patches', newId, 'edit'])
            : this.router.navigate(['/admin/hair-patches']);
        } else {
          this.router.navigate(['/admin/hair-patches']);
        }
      },
